package com.li.dc.sebc.turboFSE.view.skin.tl
{
	...
	public class SkinCircleDashed extends SkinCircle
	{
		public function SkinCircleDashed()
		{
			super();
		}
	 	private function drawDash(p:Object):void
	 	{
			...
			GraphicsUtils.drawCircle( graphics, p.centerPoint, p.radius, true, p.radius/2 );
			graphics.endFill(); 
	 	}
