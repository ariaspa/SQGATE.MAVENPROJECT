package it.lisit.siss.flex.communication.impl.soap.fse
{
	...
	internal class ParserAttributiSpecificiDCE implements IParserAttributiDCE
	{
		private var listQName:Array;
		private var listQName_2:Array;
	 
		public function ParserAttributiSpecificiDCE()
		{
		...
		private function getListQname():Array
		{
			...
			temp[ConstTipiAttributiDCE.ATTRIBUTI_REFERTO]		= new QName("http://www.crs.lombardia.it/schemas/DCSanita/FSE/2008-01/attributi_referto/","attributi_referto");
			...
			temp[ConstTipiAttributiDCE.ATTRIBUTI_ENOTE]			= new QName("http://www.crs.lombardia.it/schemas/DCSanita/FSE/2008-01/attributi_enote/","attributi_enote");								 								
			return temp;
		}
		private function getListQname2():Array
		{
			var temp:Array = new Array();
			temp[ConstTipiAttributiDCE.ATTRIBUTI_REFERTO]		= new QName("","attributi_referto");
			...
			temp[ConstTipiAttributiDCE.ATTRIBUTI_ENOTE]			= new QName("","attributi_enote");										 								
			return temp;
		}
