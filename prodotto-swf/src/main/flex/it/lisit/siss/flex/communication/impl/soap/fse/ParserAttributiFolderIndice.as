package it.lisit.siss.flex.communication.impl.soap.fse
{
	...
	internal class ParserAttributiFolderIndice implements IParserAttributiFolder
	{
		private var listQName:Array ;
		private var listQName_2:Array ;
		
		public function ParserAttributiFolderIndice()
		{
			createListQname();
		}
		//=============================================================================
		...
		{
			listQName = new Array();
			listQName[ConstTipiAttributiFolder.ATTRIBUTI_AMBULATORIALE] 		= new QName("http://www.crs.lombardia.it/schemas/DCSanita/FSE/2009-01/folder_ambulatoriale/","folder_ambulatoriale");
			listQName[ConstTipiAttributiFolder.ATTRIBUTI_CLASSIFICAZIONE_CITT] 	= new QName("http://www.crs.lombardia.it/schemas/DCSanita/FSE/2009-01/folder_classificazione_citt/","folder_classificazione_citt");
			listQName[ConstTipiAttributiFolder.ATTRIBUTI_RICOVERO] 				= new QName("http://www.crs.lombardia.it/schemas/DCSanita/FSE/2009-01/folder_ricovero/","folder_ricovero");
			listQName[ConstTipiAttributiFolder.ATTRIBUTI_PS] 					= new QName("http://www.crs.lombardia.it/schemas/DCSanita/FSE/2009-01/folder_ps/","folder_ps");
			
			listQName[ConstTipiAttributiFolder.ATTRIBUTI_FARMACI] 				= new QName("http://www.crs.lombardia.it/schemas/DCSanita/FSE/2009-01/folder_farmaci/","folder_farmaci");
			
			listQName[ConstTipiAttributiFolder.ATTRIBUTI_VACCINAZIONI] 			= new QName("http://www.crs.lombardia.it/schemas/DCSanita/FSE/2009-01/folder_vaccinazioni/","folder_vaccinazioni");
			listQName[ConstTipiAttributiFolder.ATTRIBUTI_PRERICOVERO] 			= new QName("http://www.crs.lombardia.it/schemas/DCSanita/FSE/2009-01/folder_prericovero/","folder_prericovero");
			listQName[ConstTipiAttributiFolder.ATTRIBUTI_PDT] 					= new QName("http://www.crs.lombardia.it/schemas/DCSanita/FSE/2009-01/folder_pdt/","folder_pdt");
			//////////////////////////////////////////////////
		...
		private function getAttributoSpecifico(attributi:XML,count:int=-1):VoAttributiFolder
		{
			...
			switch(count)
			{
				...
				case ConstTipiAttributiFolder.ATTRIBUTI_CLASSIFICAZIONE_CITT:
					return new VoAFClassificazioneCittadino( );
