package it.lisit.siss.flex.communication.fse.voConsultaFascicolo
{
	...
	/**
	 * Fa riferimento all'interfaccia di metodo ConsultaFascicolo
	 * DC-SEBC_FSE-SIAA#01.doc, interfaccia stadio 2
	 * @author marco
	 * 
	 */		
	public class VoInputConsultaFascicolo extends ValueObject
	{
		/**
		...
		public function VoInputConsultaFascicolo()
		{
		}
	}
}