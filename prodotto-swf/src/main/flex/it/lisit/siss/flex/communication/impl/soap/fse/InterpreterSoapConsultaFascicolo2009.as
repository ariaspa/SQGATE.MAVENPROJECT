package it.lisit.siss.flex.communication.impl.soap.fse
{
	...
	//////////////////////////////////////////////////////////////////////////////
	public class InterpreterSoapConsultaFascicolo2009 implements IInterpreterSoap
	{
		public function InterpreterSoapConsultaFascicolo2009(){}
		//=================IMPLEMENTAZIONE DELL'INTERFACCIA======================
		public function toXmlInput(vo:ValueObject=null):XML
		{
			var input:XML = enhancesSOAP(vo as VoInputConsultaFascicolo2009);
			return input;
		}
		public function toVoOutput(body:XML=null):ValueObject
		{
			var parsing:ParserConsultaFascicolo2009 = new ParserConsultaFascicolo2009( body );
		...
		{
			return new QName('http://www.crs.lombardia.it/schemas/DCSanita/FSE/2009-01/consultaFascicolo/', "FSE.consultaFascicoloResponse");
		}
		//==========================================================================
		/**
		 ...
		 * @return 
		 */	
		private function enhancesSOAP(_vo:VoInputConsultaFascicolo2009):XML
		{
			...
			if (_vo.listaRetiPatologia == null || _vo.listaRetiPatologia.length == 0) {
				XPathUtility.removeNode(consultaFascicolo, "//listaRetiPatologia");
			} else {
		...
		private const INPUT_CONSULTAFASCICOLO:XML = <SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" 
			...
			SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
				<SOAP-ENV:Body>
					<m:FSE.consultaFascicolo xmlns:m="http://www.crs.lombardia.it/schemas/DCSanita/FSE/2009-01/consultaFascicolo/" dataSetVersion="1.0">
